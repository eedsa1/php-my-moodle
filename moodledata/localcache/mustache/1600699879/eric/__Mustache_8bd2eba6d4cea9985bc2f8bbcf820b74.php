...
class __Mustache_8bd2eba6d4cea9985bc2f8bbcf820b74 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionFfbcf7ecf59a0081ba16398c244f999c($context, $indent, $value);
...
';
    ...
    private function sectionFfbcf7ecf59a0081ba16398c244f999c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<div class="dropdown mb-1 ml-auto">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<div class="dropdown mb-1 ml-auto">
';
