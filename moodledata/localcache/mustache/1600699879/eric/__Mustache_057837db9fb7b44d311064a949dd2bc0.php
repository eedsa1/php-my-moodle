...
class __Mustache_057837db9fb7b44d311064a949dd2bc0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section11b7ff38bee76a0927c53e77508b3d1e($context, $indent, $value);
...
';
    ...
    private function section11b7ff38bee76a0927c53e77508b3d1e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="dropdown mb-1 mr-auto">
    <button id="groupingdropdown" type="button" class="btn btn-outline-secondary dropdown-toggle eric" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="{{#str}} aria:groupingdropdown, block_myoverview {{/str}}">
        {{#pix}} i/filter {{/pix}}
...
';
                $buffer .= $indent . '    <button id="groupingdropdown" type="button" class="btn btn-outline-secondary dropdown-toggle eric" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="';
                // 'str' section
                $value = $context->find('str');
